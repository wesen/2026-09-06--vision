...
- [x] Create isolated workbench environment and record Python/runtime/hardware versions.
- [ ] Resolve model and conversion to immutable revisions; record weight and processor hashes.
- [x] Inspect installed embedding entry points and document actual signatures.
...
- [x] Implement separately named frame-pooled mode and space identity.
- [ ] Audit prepared frame count and original/reversed/repeated-frame controls.
- [x] Record capability failures, finite dimensions, normalization, and repeatability.
