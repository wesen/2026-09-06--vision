...
## Completed exploration setup

- [x] Create ticket and import both sources unchanged with checksum manifest.
- [x] Analyze source proposals and inspect local hardware.
...
- [x] Write the full intern guide with diagrams, pseudocode, API contracts, and file references.
