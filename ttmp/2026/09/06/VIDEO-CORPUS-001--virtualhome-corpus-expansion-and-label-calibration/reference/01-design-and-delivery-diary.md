...
Owners: []
RelatedFiles:
    - Path: repo://ttmp/2026/09/06/VIDEO-CORPUS-001--virtualhome-corpus-expansion-and-label-calibration/design-doc/01-intern-analysis-design-and-implementation-guide.md
      Note: Authored project guide
    - Path: repo://ttmp/2026/09/06/VIDEO-CORPUS-001--virtualhome-corpus-expansion-and-label-calibration/scripts/01-pdf-header.tex
      Note: Per-ticket PDF header
    - Path: repo://ttmp/2026/09/06/VIDEO-CORPUS-001--virtualhome-corpus-expansion-and-label-calibration/tasks.md
      Note: Phased implementation breakdown
    - Path: repo://ttmp/2026/09/06/VIDEO-CORPUS-001--virtualhome-corpus-expansion-and-label-calibration/various/pdf-validation.json
      Note: Visual review and artifact hashes
    - Path: repo://ttmp/2026/09/06/VIDEO-CORPUS-001--virtualhome-corpus-expansion-and-label-calibration/various/remarkable-upload.json
      Note: Successful individual delivery
ExternalSources: []
Summary: ""
LastUpdated: 2026-09-06T13:13:52.324653-04:00
WhatFor: ""
WhenToUse: ""
---
...
Record evidence, design decisions, implementation-task decomposition, and reMarkable delivery for VIDEO-CORPUS-001. This ticket is a design deliverable now; application implementation remains open.

## Step 1: Establish the project boundary

Created this child of COSMOS-VIDEO-001 and inspected the existing generator, validated corpus, teaching labs, and umbrella guide. The project scope is: Extend the working VirtualHome corpus with calibrated labels, controlled variations, and verified additional scenes. Dependencies are the existing corpus and shared schema agreements; no model ticket is a hard prerequisite.
...
Wrote the project-specific analysis, proposed contracts, data flow, decision records, implementation phases, test strategy, and review exercise. The guide explains extend the working virtualhome corpus with calibrated labels, controlled variations, and verified additional scenes. It distinguishes the working VirtualHome generator from future workbench modules and keeps the current corpus's label limits explicit.
...
- Recorded `OK: uploaded VIDEO-CORPUS-001_Intern_Guide.pdf -> /ai/2026/09/06/VIDEO-CORPUS-001`.
...
- Reproduce with the shared render script and `--ticket VIDEO-CORPUS-001`; repeat review after content/layout changes.

### Technical details
- Remote directory: `/ai/2026/09/06/VIDEO-CORPUS-001`.
- Local inspected PDF: `/Users/manuel/code/wesen/2026-09-06--vision/output/pdf/project-guides/VIDEO-CORPUS-001/VIDEO-CORPUS-001_Intern_Guide.pdf`.
