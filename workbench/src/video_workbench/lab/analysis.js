...
function saveComparisonUrl(rendered=false) {
    ...
    if(rendered)url.searchParams.set('compare','1');else {url.searchParams.delete('compare');url.searchParams.delete('compare_time_us');}
